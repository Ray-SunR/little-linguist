-- Drop ALL versions of match_books to resolve ambiguity
DROP FUNCTION IF EXISTS public.match_books(vector, double precision, integer, integer);
DROP FUNCTION IF EXISTS public.match_books(vector, double precision, integer, integer, text, text, boolean);
DROP FUNCTION IF EXISTS public.match_books(vector, double precision, integer, integer, text, text, boolean, text);
DROP FUNCTION IF EXISTS public.match_books(vector, double precision, integer, integer, integer, integer, text, boolean, integer, integer);

-- Create updated function with filtering support (FINAL VERSION)
