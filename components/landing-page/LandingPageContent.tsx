...
import { BookOpen, Sparkles, Brain, ArrowRight, Library, PenTool, Volume2, Music, Cloud, Star, Rocket, PawPrint, Microscope, Compass, Search, Loader2, Shield, Crown, Leaf } from "lucide-react";
