...
export interface DemoBook {
    id: string;
    title: string;
    tokens: readonly { i?: number; t: string; type: "w" | "s" | "p" }[];
    timings: { word: string; start: number; end: number }[];
    insights: Record<string, { word: string; definition: string; example: string; emoji: string }>;
    magicWordIndices: Set<number>;
}

// 1. Steve's Blocky Building Adventure (Original)
const STEVE_BOOK: DemoBook = {
    id: "192abf4e-7d66-4e59-8236-b6a9b2b65ab9",
    title: "Steve's Blocky Building Adventure",
    tokens: [
        { i: 0, t: "Blocky", type: "w" },
        { t: " ", type: "s" },
        { i: 1, t: "world", type: "w" },
    ...
    magicWordIndices: new Set([0, 6, 24, 30]),
};

// 2. Alex's Cloud Adventure (New Demo)
const ALEX_BOOK: DemoBook = {
    id: "alex-demo-id",
    title: "Alex's Cloud Adventure",
    tokens: [
        { i: 0, t: "Alex", type: "w" },
        { t: " ", type: "s" },
        { i: 1, t: "climbs", type: "w" },
        ...
        { i: 11, t: "giant", type: "w" },
        { t: " ", type: "s" },
        { i: 12, t: "playground", type: "w" },
        { t: ".", type: "p" },
    ],
    timings: [
        { word: "Alex", start: 0, end: 500 },
        { word: "climbs", start: 500, end: 1000 },
        { word: "the", start: 1000, end: 1200 },
        { word: "fluffy", start: 1200, end: 1700 },
        { word: "white", start: 1700, end: 2100 },
        { word: "clouds", start: 2100, end: 2800 },
        { word: "The", start: 3000, end: 3200 },
        { word: "sky", start: 3200, end: 3600 },
        { word: "is", start: 3600, end: 3800 },
        { word: "like", start: 3800, end: 4200 },
        { word: "a", start: 4200, end: 4300 },
        { word: "giant", start: 4300, end: 4800 },
        { word: "playground", start: 4800, end: 5500 },
    ],
    insights: {
        fluffy: {
            word: "Fluffy",
            definition: "Soft and light, like a cloud or a marshmallow",
            example: "The baby chick was very fluffy and yellow.",
            emoji: "☁️",
        },
        climbs: {
            word: "Climbs",
            definition: "To move upward using your hands and feet",
            example: "Alex climbs the ladder to the treehouse.",
            emoji: "🧗",
        },
    },
    magicWordIndices: new Set([3, 1, 11]),
};

export const DEMO_BOOKS = [STEVE_BOOK, ALEX_BOOK];
