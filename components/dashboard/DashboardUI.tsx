         ...
         <div className="relative inline-block mt-4 mb-4">
             ...
             >
                {activeChild?.avatar_asset_path ? (
                    <img src={activeChild.avatar_asset_path} alt={`${childName}'s Avatar`} className="w-full h-full object-cover rounded-3xl shadow-clay-purple border-4 border-purple-50" />
                ) : (
