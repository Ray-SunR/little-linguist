                  ...
                  {[
                      ...
                      return (
                          <button
                              ...
                              className={`relative p-5 rounded-3xl transition-all duration-200 active:scale-95 flex flex-col items-start gap-1.5 ${
                                  isSelected 
                  ...
                  {[
                      ...
                      return (
                          <button
                              ...
                              className={`flex-1 py-4 rounded-2xl font-bold font-fredoka text-lg transition-all duration-200 flex items-center justify-center gap-2.5 ${
                                  isSelected 
                  ...
                  {[
                      ...
                      return (
                          <button
                              ...
                              className={`px-6 py-3.5 rounded-full font-bold transition-all duration-200 active:scale-95 flex items-center gap-2.5 ${
                                  isSelected 
                 ...
                 {[
                     ...
                     return (
                        <button 
                            ...
                            className={`flex items-center gap-3 p-4 rounded-3xl transition-all duration-200 text-left active:scale-95 ${
                                isSelected 
